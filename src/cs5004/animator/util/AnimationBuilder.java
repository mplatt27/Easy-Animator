...
/**
 * This interface represents the AnimationBuilder and introduces the methods that will be
 * implemented in all classes that will implement this interface.
 *
 * @param <Doc> the document to be built.
 */
